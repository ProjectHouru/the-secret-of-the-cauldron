...
public class DeadGraveyardQuest: BaseQuest
{
    public override QuestId Id => QuestId.DeadGraveyard;
    ...
    {
        if (GameLogic.Instance.QuestSystem.CurrentQuest.Id == QuestId.CollectSkullAndTeeth)
        {
            GameLogic.Instance.TeleportToGraveYard();
        }
